...
const TredingToolsSection = () => {
  return (
    ...
    <div className='rounded-3xl bg-gradient-to-b from-[#FFFFFF] to-[#F4F9FF] py-0'>
      <div className="container mx-auto">
        <div className="grid md:grid-cols-2 gap-6">
          <div className='lg:row-start-1 max-w-lg'>
            ...
            <a href="#">
              <button className='py-4 px-10 text-primary underline invisible md:visible'>
                Learn more
              </button>
            </a>
          </div>
...
export default TredingToolsSection